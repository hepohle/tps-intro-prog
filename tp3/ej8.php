<<<<<<< HEAD
<?php
/* calcula el diámetro, perímetro y area de una cicunferencia y también el area y volumen de una esfera a partir del valor del radio*/
/*
/*Float: $radio, M_PI, $diametro, $perimetro, $superficie $superficieEsf, $volumenEsf */
